...
var SabreDevStudioFlight = (function() {
  ...
  function SabreDevStudioFlight(options) {
     ...
     * Low Fare Forecast
     *
     * https://developer.sabre.com/docs/read/rest_apis/air/intelligence/low_fare_forecast
     *
     * Example (assumes sabre_dev_studio_flight already initialized):
     * options = {
     *   origin        : 'ATL',
     ...
     * Low Fare History
     *
     * https://developer.sabre.com/docs/read/rest_apis/air/intelligence/low_fare_history
     *
     * Example (assumes sabre_dev_studio_flight already initialized):
     * options = {
     *   origin        : 'ATL',
     ...
     *   returndate    : '2014-10-01'
     * };
     * sabre_dev_studio_flight.low_fare_history(options, callback);
     */
    this.low_fare_history = function(options, callback) {
      var endpoint = '/v1/historical/shop/flights/fares';
      that.sabre_dev_studio.get(endpoint, options, callback);
    };
